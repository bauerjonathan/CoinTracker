...
export default function EthChart() {
    ...
    useEffect(() => {
        // API-Aufruf zum Abrufen der Preisdaten für ETH
        fetch("http://localhost:5000/api/crypto-history/ethereum")  // Achte darauf, dass du den richtigen Port verwendest
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen p-8">
            <h1 className="text-3xl font-bold mb-4">Ethereum Chart</h1>
